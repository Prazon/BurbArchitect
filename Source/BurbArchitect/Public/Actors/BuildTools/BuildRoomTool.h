...
#include "BuildRoomTool.generated.h"

UCLASS()
class BURBARCHITECT_API ABuildRoomTool : public ABuildWallTool
{
	GENERATED_BODY()
...
public:
	...
	void CreateRoomPreview(FVector StartLocation, FVector Direction);

...
#include "FloorPattern.generated.h"

/**
 * Floor patterns represent various flooring materials and textures
 * that can be applied to floor sections to change their appearance.
 */
UCLASS()
class BURBARCHITECT_API UFloorPattern : public UArchitectureItem
{
	GENERATED_BODY()
